...
k4a_result_t K4AROSDevice::startCameras()
{
    ...
    this->camera_timer_cg_ = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
...
k4a_result_t K4AROSDevice::startImu()
{
    ...
    this->imu_timer_cg_ = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
